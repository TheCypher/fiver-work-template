        ...
        <Col className="inputPowerCommunicationCols">
          <span>
            ...
            <UncontrolledTooltip placement="top" target="MAFLOWOUTPUT" delay={0}>
              ...
              and will require separate input power for the meter electronics.            </UncontrolledTooltip>
          </span>
        ...
        <Col className="inputPowerCommunicationCols">
          <span>
            ...
            <UncontrolledTooltip placement="top" target="MATEMPOUTPUT" delay={0}>
              ...
              This output is Self Powered.            </UncontrolledTooltip>
          </span>
        ...
        <Col className="inputPowerCommunicationCols">
          <span>
            ...
            <UncontrolledTooltip placement="top" target="VDCFLOWOUTPUT" delay={0}>
              ...
              Please specify which voltage range you require.            </UncontrolledTooltip>
          </span>
          <FormGroup check className="form-check-radio">
            <Label check>
        ...
        <Col className="inputPowerCommunicationCols">
          <span>
            ...
            <UncontrolledTooltip placement="top" target="VDCTEMPOUTPUT" delay={0}>
              ...
              Generally, the 0 VDC represents the minimum value, and the 5 (or 10) VDC represents the maximum value. 
              Please specify which voltage and temperature range you require.            </UncontrolledTooltip>
          </span>
          <FormGroup check className="form-check-radio">
            <Label check>
              <span className="customizerInputTitleSmallX1">0-5</span>
